...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Strangers_bots")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME", "alexaprobot")
# Don't Add style font 
BOT_NAME = getenv("BOT_NAME", "alexa MUSIC")
#get Your Assistant User name
ASSUSERNAME = getenv("ASSUSERNAME", "Alexa_assistant")
...
LOGGER_ID = int(getenv("LOGGER_ID", "-1001916025357"))

# Get this value from  on Telegram by /id
OWNER_ID = int(getenv("OWNER_ID", "6886160138"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Shivasengar12/Nyka",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/strangers_bots")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/dreamyworldxD")
